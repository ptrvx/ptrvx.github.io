(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NewsComponent = /** @class */ (function () {
                ...
                NewsComponent.prototype.showNews = function () {
                    var _this = this;
                    this.newsService.getNews(this.keyword).subscribe(function (data) {
                ...
                NewsComponent.prototype.getStoredLikes = function () {
                    this.likes = JSON.parse(localStorage.getItem('likes')) || [];
                };
                NewsComponent.prototype.storeLikes = function () {
                    localStorage.setItem('likes', JSON.stringify(this.likes));
                };
                NewsComponent.prototype.checkLikes = function () {
                ...
                NewsComponent.prototype.like = function (url) {
                    this.getStoredLikes();
                    if (this.likes.includes(url)) {
                        this.likes = this.likes.filter(function (a) { return a != url; });
                    }
                    else {
                        this.likes.push(url);
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NewsService = /** @class */ (function () {
                ...
                NewsService.prototype.getNews = function (keyword) {
